...
USE_SECOND_DB = is_enabled((environ.get('USE_SECOND_DB', "False")), False)  # True to enable second DB, False to disable
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002627006758'))  # Log channel id (make sure bot is admin)
